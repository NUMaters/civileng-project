...
export const HOWTO_PURPOSE = {
  title: "このゲームの目的",
  body: "阿武隈川沿いの街を大雨から守る、スマホ向け治水チャレンジ。限られた予算と時間で、弱点に合う施設を配置しよう。",
};

export const HOWTO_STEPS: { title: string; body: string }[] = [
  {
    title: "1. 上へドラッグ",
    body: "画面下の治水ツールを、川や河岸の置きたい場所まで指でドラッグして離します。横方向の操作ではツール一覧を送れます。",
  },
  {
    title: "2. 位置と向きを確認",
    body: "仮置きした施設をドラッグして位置を微調整し、向きスライダーで川の流れや岸に合わせます。",
  },
  {
    title: "3. 配置を確定",
    body: "「配置を確定」を押すと予算を消費して建設します。被災度8%未満を目指し、大雨中も必要なら追加配置できます。",
  },
];
...
export const HOWTO_FACILITIES: HowtoFacilityGuide[] = [
  {
    ...
    mechanism:
      "岸に沿って土やコンクリートの壁を造り、水位が上がっても市街地へ流れ込ませない。向きを川沿いに合わせると効果が高い。",
    realWorld:
      "日本の河川で最も基本的な治水施設。計画高水位を想定した高さ・断面で連続して築かれ、越水や破堤の防止が目的。",
  ...
  },
  {
    ...
    mechanism:
      "石・コンクリートなどで河岸表面を保護し、湾曲部など流速が速い場所の侵食を抑える。溢れそのものは止められない。",
    realWorld:
      "蛇行部や橋脚周辺など、河岸が削られやすい区間に施工。根固めや法覆工と組み合わせ、河道の形状を保つ。",
  ...
  },
  {
    ...
    realWorld:
      "ゼロメートル地帯や都市の低平地で、下水道や河川への自然排水が難しいときに使われる。雨水ポンプ場とも呼ばれる。",
  ...
  },
  {
    ...
    mechanism:
      "河道の一部や周囲の低地に洪水を導き、ピーク流量をカットしてからゆっくり戻す。決壊口を塞ぐ施設ではない。",
    realWorld:
      "渡良瀬遊水地など、日本各地の大河川で採用。平時は農地や自然地、洪水時は貯留空間として機能する。",
  ...
  },
  {
    ...
    mechanism:
      "土砂を取り除き断面を大きくすることで水位を下げ、流下能力を高める。湾曲部では流速が増し侵食を悪化させうる。",
    realWorld:
      "堆積した土砂の浚渫や低水路掘削として全国の河川で実施。維持管理とセットで、再び堆砂しないよう計画する。",
